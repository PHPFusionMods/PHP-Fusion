...
if (isset($_GET['activate'])) {
	...
	$username = (isset($_POST['username']) ? stripinput(trim(preg_replace("/ +/i", " ", $_POST['username']))) : "");
	$email = (isset($_POST['email']) ? stripinput(trim(preg_replace("/ +/i", "", $_POST['email']))) : "");
	$password1 = (isset($_POST['password1']) ? stripinput(trim(preg_replace("/ +/i", "", $_POST['password1']))) : "");
