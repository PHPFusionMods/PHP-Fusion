...
class UserFields {
	...
	public function displayInput() {
		...
		$this->html .= "	function ValidateForm(frm) {\n";
		/*
		$this->html .= "		if ($(frm.user_new_password).val() != \"\") {\n";
		$this->html .= "			if ($(frm.user_new_password2).val() != $(frm.user_new_password).val()) {\n";
		$this->html .= "				$(frm.user_new_password2).addClass(\"tbl-error\");\n";
		$this->html .= "				alert(\"".$locale['u132'].$locale['u143']."\");\n";
		$this->html .= "				return false;\n";
		$this->html .= "			}\n";
		$this->html .= "			$(frm.user_new_password2).removeClass(\"tbl-error\");\n";
		$this->html .= "			if ($(frm.user_password).val() == \"\") {\n";
		$this->html .= "				$(frm.user_password).addClass(\"tbl-error\");\n";
		$this->html .= "				alert(\"".$locale['u138']."\");\n";
		$this->html .= "				return false;\n";
		$this->html .= "			}\n";
		$this->html .= "			$(frm.user_password).removeClass(\"tbl-error\");\n";
		$this->html .= "			if ($(frm.user_new_password).val() == $(frm.user_password).val()) {\n";
		$this->html .= "				$(frm.user_new_password).addClass(\"tbl-error\");\n";
		$this->html .= "				$(frm.user_new_password2).addClass(\"tbl-error\");\n";
		$this->html .= "				alert(\"".$locale['u134'].$locale['u146'].$locale['u133']."\");\n";
		$this->html .= "				return false;\n";
		$this->html .= "			}\n";
		$this->html .= "			$(frm.user_new_password).removeClass(\"tbl-error\");\n";
		$this->html .= "			$(frm.user_new_password2).removeClass(\"tbl-error\");\n";
		$this->html .= "		}\n";
		*/
		$this->html .= $this->javaScriptRequired;
		$this->html .= "	}\n";
		$this->html .= $this->javaScriptOther;
		$this->html .= "</script>\n";
	...
	private function basicOutputField($name, $value, $class, $rowspan = 0) {
		...
		$returnHTML = "<tr>\n";
		if ($rowspan > 0) {
			$returnHTML .= "<td rowspan='".$rowspan."' valign='top' class='tbl profile_user_avatar'><!--profile_user_avatar-->";
	...
	private function renderBaicOutputFields() {
		...
		$lastVisit = $this->userData['user_lastvisit'] ? showdate("longdate", $this->userData['user_lastvisit']) : $locale['u065'];
