...
define("COOKIE_DOMAIN", $settings['site_host'] != 'localhost' ? $settings['site_host'] : false);
...
class Authenticate {
	...
	public static function setUserCookie($userID, $salt, $algo, $remember = false, $userCookie = true) {
		...
		$cookiePath = COOKIE_PATH; $cookieNane = COOKIE_USER;
		...
		setcookie($cookieNane, $cookieContent, $cookieExpiration, $cookiePath, COOKIE_DOMAIN, false, true);
	...
	public static function logOut() {
		...
		//header("P3P: CP='NOI ADM DEV PSAi COM NAV OUR OTRo STP IND DEM'");
		setcookie(COOKIE_USER, "", time() - 1209600, COOKIE_PATH, COOKIE_DOMAIN, false, true);
		setcookie(COOKIE_LASTVISIT, "", time() - 1209600, COOKIE_PATH, COOKIE_DOMAIN, false, true);
	...
	public static function setLastVisitCookie() {
		...
		if (isset($_COOKIE[COOKIE_LASTVISIT]) && isnum($_COOKIE[COOKIE_LASTVISIT])) {
			...
			//header("P3P: CP='NOI ADM DEV PSAi COM NAV OUR OTRo STP IND DEM'");
			setcookie(COOKIE_LASTVISIT, $lastvisit, time() + 3600, COOKIE_PATH, COOKIE_DOMAIN, false, true);
