...
if (!empty($result)) {
	...
	echo "<strong>".(500 - mb_strlen($download_description_short))."</strong>";
	echo "</span>";
	echo "</td>\n";
	echo "<td class='tbl1'><textarea name='download_description_short' cols='60' rows='4' class='textbox' style='width:380px;' onkeydown=\"shortdesc_counter(this,'shortdesc_display',500);\" onkeyup=\"shortdesc_counter(this,'shortdesc_display',500);\">".$download_description_short."</textarea></td>\n";
	echo "</tr>\n";
