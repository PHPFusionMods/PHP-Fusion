...
$dl_stats .= "<tr>\n<td class='tbl2' valign='middle'><img src='".get_image("statistics")."' alt='Download Stats' /></td>\n";
			...
			if (checkgroup($cat_data['download_cat_access'])) {
				...
				if ($rows != 0) {
					...
					if ($rows > $settings['downloads_per_page']) {
						echo "<tr>\n<td colspan='8' class='tbl2' style='text-align:center;'>\n".makepagenav($_GET['rowstart'.$cat_data['download_cat_id']], $settings['downloads_per_page'], $rows, 3, FUSION_SELF."?cat_id=".$cat_data['download_cat_id']."&amp;", "rowstart".$cat_data['download_cat_id'])."\n</td></tr>\n"; }
				} else {
